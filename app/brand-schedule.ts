...
export const BRAND_CYCLE_DAYS = 7;

/** Monday through Sunday identities, anchored to 7 September 2026 in Asia/Kolkata. */
export function logoForDate(date: Date): number {
  ...
  return ((day - firstDay) % BRAND_CYCLE_DAYS + BRAND_CYCLE_DAYS) % BRAND_CYCLE_DAYS + 1;
}
